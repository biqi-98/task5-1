...
public class CourseServiceImpl implements CourseService {
    ...
    public String saveCourseLessonInfo(Course_Lesson courseLesson) {
        //1.补全信息
        String strDate = DateUtils.getDateFormart();
        courseLesson.setCreate_time(strDate);
        courseLesson.setUpdate_time(strDate);

        //2.执行插入操作
        int row = courseDao.saveCourseLessonInfo(courseLesson);
    ...
    public Course_Lesson findCourseLessonById(int id) {
        return courseDao.findCourseLessonById(id);
    }
    ...
    public String updateCourseLessonInfo(Course_Lesson courseLesson) {
        ...
        //2.执行插入操作
        int row = courseDao.updateCourseLessonInfo(courseLesson);
