...
public class CourseDaoImpl implements CourseDao {
    ...
    public int saveCourseLessonInfo(Course_Lesson courseLesson) {
        try {
            ...
            //3.准备参数
            Object[] param = {courseLesson.getCourse_id(),courseLesson.getSection_id(),courseLesson.getTheme(),courseLesson.getDuration(),
                    courseLesson.getIs_free(),courseLesson.getOrderNum(),courseLesson.getCreate_time(),courseLesson.getUpdate_time()};
    ...
    public int updateCourseLessonInfo(Course_Lesson courseLesson) {
        try {
            ...
            Object[] param = {courseLesson.getCourse_id(),courseLesson.getSection_id(),courseLesson.getTheme(),courseLesson.getDuration(),
                    courseLesson.getIs_free(),courseLesson.getOrderNum(),courseLesson.getUpdate_time(),courseLesson.getId()};
